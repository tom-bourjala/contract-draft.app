...
If a clause get the key "common", it will act as a common inputs list for all clauses.
You can use any of the common inputs in any clause by using the following syntax: `{{$inputKey}}`.
...
>*[Try this example here](https://contract-drafter.com/?t=N4Igxg9gtlEHYgFykjeBJOAHArgFwEYlQ8kRSAaEAGzIEEACVWOBgS23xAF9uqAzNgCcAzngD6YagEMcIgKbEaZAGLCxTGXMVUwZALSGGwYABJmGToV48qCyHAAmkrQqW1EIAMryHjzbJuugZGJubQLJi41tw83EA).*
